<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">DIPA INNOVATION FEST</a>
        </div>
        ...
        <ul class="sidebar-menu">
            <li class="{{ Request::is('dashboard') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('dashboard.index') }}"><i class="far fa-square"></i> <span>Dashboard</span></a>
            </li>            {{-- <li class="nav-item dropdown {{ $type_menu === 'dashboard' ? 'active' : '' }}"> --}}
            ...
            <li class="menu-header">Kelola Event</li>
            <li class="{{ Request::is('peserta') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('peserta.index') }}"><i class="far fa-square"></i> <span>Peserta</span></a>
            </li>
            <li class="{{ Request::is('evenet') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ route('event.index') }}"><i class="far fa-square"></i> <span>Event</span></a>
            </li>
            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                <a class="nav-link"
                    href="{{ url('pembayaran') }}"><i class="far fa-square"></i> <span>Pembayaran</span></a>
            </li>
            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                <a class="nav-link"
